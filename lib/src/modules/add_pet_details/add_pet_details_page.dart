          ...
          child: Column(
            children: [
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      CustomTextField(
                        'Your pet name',
                        controller: provider.petName,
                        hint: 'enter your pet name',
                        validator: provider.petNameValidation,
                      ),
                      CustomTextField(
                        'Your pet owner name',
                        validator: provider.petOwnerNameValidation,
                        hint: 'enter your pet owner name',
                      ...
                      CustomDropDown(
                        ...
                        provider: provider,
                        validator: provider.typeOfPetValidation,
                      ...
                      CustomDropDown(
                        ...
                        provider: provider,
                        validator: provider.genderValidation,
                        onChange: provider.onChangeGender,
                      ),
                      CustomTextField(
                        'Enter pet location',
                        validator: provider.locationValidation,
                        hint: 'enter your pet location',
                        controller: provider.location,
                      ),
                      TextArea(
                        'Additional Notes',
                        controller: provider.additionalNotes,
                      ),
              ...
              SubmitButtonWithIcon(
                label: 'Submit',
                onPressed:
                    provider.submitBtnPressed ? null : provider.validation,
              )
            ],
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (context.select((AddPetDetailsProvider a) =>
            a.pickedImage == null && a.pickedImageWarning != null))
          CustomPadding(
              padding: EdgeInsets.only(left: 12),
              child: Selector(
                selector: (context, AddPetDetailsProvider p) =>
                    p.pickedImageWarning,
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
              ...
              isDense: true,
              border: customBorder(radius: 15),
              enabledBorder: customBorder(radius: 15),
              focusedBorder:
                  customBorder(radius: 15, borderColor: AppData.primaryColor)),
        ),
      ],
    );
  }
